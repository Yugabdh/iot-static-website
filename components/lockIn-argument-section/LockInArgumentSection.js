                ...
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="mt-12 text-center">
                        <Link
                            ...
                            className="inline-flex items-center rounded-lg bg-gradient-to-br from-sky-700 to-slate-900 px-6 py-3 text-center font-medium text-white transition hover:bg-gradient-to-bl focus:outline-none focus:ring-4 focus:ring-slate-300"
                        >
