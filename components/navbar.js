                            ...
                            <div className="space-y-2 py-6">
                                {navigationConfig.map((item) => (
                                    <Link
                                        key={item.title}
                                        href={item.href}
                                        className={clsx("-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-gray-50", path==item.href? "text-sky-700 bg-gray-50": "text-gray-900")}
                                    >
                                        {item.title}
                                    </Link>
                                ))}
